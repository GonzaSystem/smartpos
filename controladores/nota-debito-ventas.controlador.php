...
class ControladorNotaDebitoVentas{

	/*Mostrar ventas*/


	static public function ctrMostrarNotaDebitoVentas($item, $valor){


		$tabla = "nota_debito_venta";

		$respuesta = ModeloNotaDebitoVentas::mdlMostrarNotaDebitoVentas($tabla, $item, $valor);

		return $respuesta;
	}

	/*Crear ventas*/
	static public function ctrCrearNotaDebitoVenta(){
		...
		if($CbteTipo == "2"){
			...
			$respuesta = ModeloNotaDebitoVentas::mdlIngresarNotaDebitoVenta($tabla, $datos);
			...
			if($respuesta == "ok"){
					...
					swal({
						  type: "success",
						  title: "La nota de débito ha sido guardada correctamente.",
						  ...
						  confirmButtonText: "Cerrar"
									...
									window.location = "nota-debito-ventas";
	...
	static public function ctrRangoFechaNotaDebitoVentas($fechaInicial, $fechaFinal){

		$tabla = "nota_debito_venta";

		$respuesta = ModeloNotaDebitoVentas::mdlRangoFechaNotaDebitoVentas($tabla, $fechaInicial, $fechaFinal);
	...
	public function ctrDescargarNotaDebitoReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			if(isset($_GET["fechaInicial"]) && isset($_GET["fechaFinal"])){
				...
				$ventas = ModeloNotaDebitoVentas::mdlRangoFechaNotaDebitoVentas($tabla, $_GET["fechaInicial"], $_GET["fechaFinal"]);
				...
				$ventas = ModeloNotaDebitoVentas::mdlMostrarNotaDebitoVentas($tabla, $item, $valor);
	...
	public function ctrSumaTotalNotaDebitoVentas(){

		$tabla = "nota_debito_venta";
		$respuesta = ModeloNotaDebitoVentas::mdlSumaTotalNotaDebitoVentas($tabla);
