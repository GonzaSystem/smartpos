...
class ControladorNotaCreditoVentas{

	/*Mostrar ventas*/


	static public function ctrMostrarNotaCreditoVentas($item, $valor){


		$tabla = "nota_credito_venta";

		$respuesta = ModeloNotaCreditoVentas::mdlMostrarNotaCreditoVentas($tabla, $item, $valor);

		return $respuesta;
	}

	/*Crear ventas*/
	static public function ctrCrearNotaCreditoVenta(){
		...
		if($CbteTipo == "3"){
			...
			$datos = array("id_vendedor"=>$_POST["idVendedor"],
						   ...
						   "concepto"=>$_POST["conceptoNotaCredito"],
						   "cae"=>$res['CAE'],
						   "vencimiento_cae"=>$res['CAEFchVto']);


			$respuesta = ModeloNotaCreditoVentas::mdlIngresarNotaCreditoVenta($tabla, $datos);
			...
			if($respuesta == "ok"){
					...
					swal({
						  type: "success",
						  title: "La nota de crédito ha sido guardada correctamente.",
							text: "Número de comprobante: '.$valfac.'",
						  showConfirmButton: true,
						  confirmButtonText: "Cerrar"
						  }).then(function(result){
									if (result.value) {

									window.location = "nota-credito-ventas";
	...
	static public function ctrRangoFechaNotaCreditoVentas($fechaInicial, $fechaFinal){

		$tabla = "nota_credito_venta";

		$respuesta = ModeloNotaCreditoVentas::mdlRangoFechaNotaCreditoVentas($tabla, $fechaInicial, $fechaFinal);
	...
	public function ctrDescargarNotaCreditoReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			if(isset($_GET["fechaInicial"]) && isset($_GET["fechaFinal"])){
				...
				$ventas = ModeloNotaCreditoVentas::mdlRangoFechaNotaCreditoVentas($tabla, $_GET["fechaInicial"], $_GET["fechaFinal"]);
				...
				$ventas = ModeloNotaCreditoVentas::mdlMostrarNotaCreditoVentas($tabla, $item, $valor);
	...
	public function ctrSumaTotalNotaCreditoVentas(){

		$tabla = "nota_credito_venta";
		$respuesta = ModeloNotaCreditoVentas::mdlSumaTotalNotaCreditoVentas($tabla);
