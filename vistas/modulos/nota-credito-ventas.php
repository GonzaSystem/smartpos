      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">
        ...
        <tbody>
          ...
          $respuesta = ControladorNotaCreditoVentas::ctrRangoFechaNotaCreditoVentas($fechaInicial, $fechaFinal);
           ...
           echo '<tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-info btnImprimirNotaCredito" codigoVenta="'.$value["id"].'">
