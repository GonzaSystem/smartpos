						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<?php
										...
										$ventas = ControladorNotaDebitoVentas::ctrMostrarNotaDebitoVentas($item, $valor);
              ...
              <td>
				...
				<br>
					...
					<div class="box-footer">
						...
						<button type="submit" class="btn btn-primary pull-right">Crear nota de débito</button>
				...
				<?php
					...
					$generaVenta = new ControladorNotaDebitoVentas();
          $generaVenta -> ctrCrearNotaDebitoVenta();
