...
class ModeloNotaDebitoVentas{

	static public function mdlMostrarNotaDebitoVentas($tabla, $item, $valor){
	...
	static public function mdlIngresarNotaDebitoVenta($tabla, $datos){
	...
	static public function mdlRangoFechaNotaDebitoVentas($tabla, $fechaInicial, $fechaFinal){
	...
	static public function mdlSumaTotalNotaDebitoVentas($tabla){
