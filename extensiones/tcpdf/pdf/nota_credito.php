...
require_once "../../../controladores/nota-credito-ventas.controlador.php";
require_once "../../../modelos/nota-credito-ventas.modelo.php";
...
class imprimirFactura{
	...
	$respuestaVenta = ControladorNotaCreditoVentas::ctrMostrarNotaCreditoVentas($itemVenta, $valorVenta);
    ...
    $concepto = $respuestaVenta["concepto"];
		...
		<br>
			...
			<td style="width:220px">
				...
				<div style="font-size:10px; text-align:right; line-height:15px">
					...
					<b style="font-size:17px">NOTA DE CRÉDITO</b>
...
$bloque2 = <<<EOF
	...
	<td style="border: 1px solid #666; background-color:white; width:190px; text-align:left">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:200px">Vendedor: $respuestaVendedor[nombre]</td>



			<td style="border: 1px solid #666; background-color:white; width:340px">Concepto: $concepto 
